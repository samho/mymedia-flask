...
DEFAULT_PAGE_SIZE = os.environ.get('MYMEDIA_DEFAULT_PAGE_SIZE') or 8
...
PHOTO_PER_PAGE = os.environ.get('MYMEDIA_PHOTO_PER_PAGE') or 8

MOVIE_TYPE = os.environ.get('MYMEDIA_MOVIE_TYPE') or {"REGULAR": 9, "ADULT": 10}
MOVIE_PER_PAGE = os.environ.get('MYMEDIA_MOVIE_PER_PAGE') or 8
